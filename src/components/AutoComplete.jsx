  ...
  return (
    <div className='relative z-50'>
      <form className='relative flex justify-center items-center w-[20.5rem] h-6 rounded-lg m-auto' onSubmit={handleSubmit}> 
        <input type='text' className='text-xs w-[20.5rem] h-6 px-2 py-1 rounded-lg text-gray-300 text-center bg-[hsl(214,13%,47%)]' value={searchTerm} onChange={(event) => {setSearchTerm(event.target.value);}}/>
